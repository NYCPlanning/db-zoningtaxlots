...
\copy (SELECT * FROM ztl_qc_versioncomparisonnownullcount ORDER BY count DESC) TO '/prod/db-zoningtaxlots/zoningtaxlots_build/output/ztl_qc_versioncomparisonnownullcount.csv' DELIMITER ',' CSV HEADER;
DROP TABLE IF EXISTS ztl_qc_versioncomparisonnownullcount;